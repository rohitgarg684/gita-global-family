...
export default function HomePage() {
  return (
    <>
      ...
      {/* Clips — Protecting Sanatan Dharma */}
      <section className="py-16 md:py-24 bg-dark-brown">
        <div className="section-padding">
          ...
          >
            <div className="inline-flex items-center gap-2 mb-4 px-4 py-2 bg-saffron/15 rounded-full border border-saffron/30">
              ...
              <span className="text-saffron-light text-sm font-medium">Clips</span>
            </div>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-white leading-tight">
              Voices for Sanatan Dharma
            </h2>
            <p className="mt-3 text-base md:text-lg max-w-2xl mx-auto text-white/70 leading-relaxed">
              Short, powerful clips on why protecting our heritage is the need of the hour.
            </p>
          </motion.div>
          <ClipsCarousel />
          <div className="text-center mt-8">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600 via-pink-500 to-orange-400 text-white text-sm font-semibold rounded-full hover:opacity-90 transition-opacity shadow-lg"
            >
